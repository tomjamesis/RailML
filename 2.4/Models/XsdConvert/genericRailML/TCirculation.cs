...
namespace Models.XsdConvert.genericRailML
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("tCirculation", Namespace="https://www.railml.org/schemas/2018")]
    ...
    internal partial class TCirculation : IACirculation, genericRailML.IAnyAttribute
    {
        ...
        /// </summary>
        [System.Xml.Serialization.XmlAttributeAttribute("blockRef")]
        ...
        /// <para>generic type for counters (e.g. number of equipment), allowing zero</para>
        /// </summary>
        [System.Xml.Serialization.XmlAttributeAttribute("vehicleCounter")]
        ...
        /// <para>generic type for counters (e.g. number of equipment), allowing zero</para>
        /// </summary>
        [System.Xml.Serialization.XmlAttributeAttribute("vehicleGroupCounter")]
        public string VehicleGroupCounter { get; set; }
        
        /// <summary>
        /// <para>an XML-side constrained reference to one xs:ID value, acts across an XML file including its outsourced components (xi:include mechanism)</para>
        /// </summary>
        [System.Xml.Serialization.XmlAttributeAttribute("nextBlockRef")]
        ...
        /// <para>an XML-side constrained reference to one xs:ID value, acts across an XML file including its outsourced components (xi:include mechanism)</para>
        /// </summary>
        [System.Xml.Serialization.XmlAttributeAttribute("nextOperatingPeriodRef")]

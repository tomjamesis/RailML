...
namespace Models.XsdConvert.genericRailML
{
    ...
    [XmlTypeAttribute("TValueTableValueLine", Namespace="https://www.railml.org/schemas/2018", AnonymousType=true)]
    ...
    internal partial class TValueTableValueLine
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<TValueTableValueLineValues> _values;
        
        /// <summary>
        /// <para>the values related to an x-value themselves</para>
        /// </summary>
        [XmlElementAttribute("values", Order=0)]
        public Collection<TValueTableValueLineValues> Values
        {
            get
            {
                return this._values;
        ...
        {
            this._values = new Collection<TValueTableValueLineValues>();
        }
        
        /// <summary>
        /// <para>values of abscissa (x-axis) for this line (row)</para>
        /// </summary>
        [XmlAttributeAttribute("xValue")]

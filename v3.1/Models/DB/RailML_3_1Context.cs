...
namespace Models.DB
{
    public partial class RailML_3_1Context : DbContext
    {
        public RailML_3_1Context()
        {
        }

        public RailML_3_1Context(DbContextOptions<RailML_3_1Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=(localdb)\\ProjectsV13;Initial Catalog=RailML_3_1;Integrated Security=True;Persist Security Info=False");
            }
        }

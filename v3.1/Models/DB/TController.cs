...
namespace Models.DB
{
    ...
    internal partial class TController : TElementWithIDAndName, IAController
    {
        ...
        private System.Collections.ObjectModel.Collection<TElementRefInGroup> _ocpRef;
        
        /// <summary>
        /// <para>reference from a controller to an OCP</para>
        /// </summary>
        [System.Xml.Serialization.XmlElementAttribute("ocpRef", Order=1)]
        public System.Collections.ObjectModel.Collection<TElementRefInGroup> OcpRef
        {
            get
            {
                return this._ocpRef;
        ...
        public TController()
        {
            this._ocpRef = new System.Collections.ObjectModel.Collection<TElementRefInGroup>();
        }

...
namespace Models.XsdConvert.genericRailML
{
    ...
    [XmlTypeAttribute("eFormation", Namespace="https://www.railml.org/schemas/2018")]
    ...
    internal partial class EFormation : genericRailML.TFormation
    {
        ...
        /// </summary>
        [XmlElementAttribute("trainOrder", Order=0)]
        public ETrainOrder TrainOrder { get; set; }
        
        [XmlIgnoreAttribute()]
        private Collection<genericRailML.TElementWithReference> _categoryRef;
        
        /// <summary>
        /// <para>reference to train categories in TimeTable part, e.g. ltd. Express, the formation can run as in service</para>
        /// </summary>
        [XmlElementAttribute("categoryRef", Order=1)]
        public Collection<genericRailML.TElementWithReference> CategoryRef
        {
            get
            {
        ...
        public EFormation()
        {
            this._categoryRef = new Collection<genericRailML.TElementWithReference>();
            this._trainBrakeOperation = new Collection<genericRailML.TBasicBrakeOperation>();
            this._speedProfileRef = new Collection<genericRailML.TSpeedProfileRefRS>();
            this._technicalStopActivity = new Collection<genericRailML.TTechnicalStopActivity>();
        }
        
        /// <summary>
        /// <para>acceleration value for whole formation</para>
        /// </summary>
        [XmlElementAttribute("trainEngine", Order=2)]
        public genericRailML.TTrainEngine TrainEngine { get; set; }
        
        /// <summary>
        /// <para>for whole formation deceleration</para>
        /// </summary>
        [XmlElementAttribute("trainBrakes", Order=3)]
        public genericRailML.TBasicBrakeType TrainBrakes { get; set; }
        
        [XmlIgnoreAttribute()]
        private Collection<genericRailML.TBasicBrakeOperation> _trainBrakeOperation;
        
        /// <summary>
        /// <para>operational braking rules according to specific supervision regime for entire formation</para>
        /// </summary>
        [XmlElementAttribute("trainBrakeOperation", Order=4)]
        public Collection<genericRailML.TBasicBrakeOperation> TrainBrakeOperation
        {
            get
            {
        ...
        /// </summary>
        [XmlElementAttribute("trainResistance", Order=5)]
        public genericRailML.TTrainResistance TrainResistance { get; set; }
        
        [XmlIgnoreAttribute()]
        private Collection<genericRailML.TSpeedProfileRefRS> _speedProfileRef;
        
        /// <summary>
        /// <para>reference to permissible speed profiles for entire formation</para>
        /// </summary>
        [XmlElementAttribute("speedProfileRef", Order=6)]
        public Collection<genericRailML.TSpeedProfileRefRS> SpeedProfileRef
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<genericRailML.TTechnicalStopActivity> _technicalStopActivity;
        
        /// <summary>
        /// <para>list of stop activities with their related technical times</para>
        /// </summary>
        [XmlElementAttribute("technicalStopActivity", Order=7)]
        public Collection<genericRailML.TTechnicalStopActivity> TechnicalStopActivity
        {
            get
            {
